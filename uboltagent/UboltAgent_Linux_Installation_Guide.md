...
```bash
wget http://umon.api.service.ucloud.cn/static/cloudwatch/uboltagent-v1.3.2-linux-amd64.tar.gz
```

**arm64 架构：**

```bash
wget http://umon.api.service.ucloud.cn/static/cloudwatch/uboltagent-v1.3.2-linux-arm64.tar.gz
```
...
```bash
curl -O http://umon.api.service.ucloud.cn/static/cloudwatch/uboltagent-v1.3.2-linux-amd64.tar.gz
```

**arm64架构:** 

```bash
curl -O http://umon.api.service.ucloud.cn/static/cloudwatch/uboltagent-v1.3.2-linux-arm64.tar.gz
```
...
```bash
tar -zxf uboltagent-v1.3.2-linux-amd64.tar.gz
```

**arm64 架构：**

```bash
tar -zxf uboltagent-v1.3.2-linux-arm64.tar.gz
```
