...
```bash
wget http://umon.api.service.ucloud.cn/static/cloudwatch/uboltagent-v1.3.0-linux-arm64.tar.gz
```
...
```bash
curl -O http://umon.api.service.ucloud.cn/static/cloudwatch/uboltagent-v1.3.0-linux-arm64.tar.gz
```
...
```bash
tar -zxf uboltagent-v1.3.0-linux-arm64.tar.gz
```
