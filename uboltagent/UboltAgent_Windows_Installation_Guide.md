...
```
http://umon.api.service.ucloud.cn/static/cloudwatch/uboltagent-v1.3.3-windows-amd64.exe
```

**操作系统windows2012及以下版本**

```
http://umon.api.service.ucloud.cn/static/cloudwatch/uboltagent-v1.3.3-windows-amd64-compat.exe
```
...
进入安装包存放目录，找到下载的安装包：  `uboltagent-v1.3.3-windows-amd64*.exe`，双击该文件开始安装过程，按照安装向导提示完成安装。
