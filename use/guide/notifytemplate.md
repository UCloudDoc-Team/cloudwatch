...
![](../../images/image-20260127195350566.png)

### 操作步骤

1. **进入创建页面**：点击 `「+ 创建通知模板」`。
   ![](../../images/image-20260127195443119.png)
...
![](../../images/image-20260127195705659.png)
...
2. 在通知设置中选择 **通知模板**
   ![](../../images/image-20260127195806359.png)
3. 选择目标模板并提交

### 编辑存量告警策略

- 原有手动配置仅做展示，支持快速保存为通知模板
  ![](../../images/image-20260127195846081.png)
